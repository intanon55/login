            ...
            <div class="card-body">
                ...
                ?>
                    <div class="form-group">
                        <input type="text" class="form-control" name="txt_username" placeholder="Username or E mail ID" required />
                    </div>
                    <div class="form-group">
                    ...
                    <br />
                    <label>ยังไม่ได้เป็นสมาชิก? <a href="sign-up.php">สมัครที่นี้</a></label>
                </form>
            </div>
        </div>
    </div>
